...
#Region "Eventos"
    ...
    Sub Evento_Click(ByVal sender As Object, ByVal e As EventArgs) Handles Btn1.Click
        ...
        If Grid1.Rows.FixedRows.Count = 0 Then
            MessageBox.Show("Seleccione al menos un Suministro", Mensaje.Comacsa, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
            Return
        End If
...
#Region "Procedimientos"
    ...
    Sub Iniciar()
        ...
        Entidad.MyLista = Negocio.Producto.ConsultarSuministros_Enlace()

        If Entidad.MyLista.Validacion Then
            Ls_Suministro = Entidad.MyLista.Ls_Ruma
        End If
