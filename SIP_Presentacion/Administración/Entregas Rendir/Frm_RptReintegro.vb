...
Public Class Frm_RptReintegro
    Dim ReportesBL As New NGReportes
    Dim tblSolicitud As DataTable = Nothing
    Public esDevolucion As Int32 = 0
    Private Sub Frm_RptReintegro_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Call Iniciar()
    End Sub
    Sub Iniciar()
        Try
            Dim ds1 As New DataSet
            Dim Listar As New Crp_Reintegro1
            If esDevolucion = 0 Then
                ds1 = ReportesBL.RptLiquidacionReintegro(nroSolicitud)
            Else
