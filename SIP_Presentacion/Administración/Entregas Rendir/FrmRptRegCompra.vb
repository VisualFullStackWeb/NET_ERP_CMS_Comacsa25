...
Public Class FrmRptRegCompra
    ...
    Sub Iniciar()
        Try
            ...
            Dim Listar As New Crp_Reg_Compras
            If flgprovision = "0" Then
                ds1 = ReportesBL.RptRegCompras(nroSolicitud)
            ElseIf flgprovision = "1" Then
                ds1 = ReportesBL.RptRegCompras_Prov(nroSolicitud)
            End If
