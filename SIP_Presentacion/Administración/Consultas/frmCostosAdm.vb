...
#End Region
    ...
    Private Sub btnReporte_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnReporte.Click
        Try
            ...
            _objEntidad.tipodoc = cmbTipo.Value
            Dim dtDatos As New DataTable
            dtDatos = _objNegocio.RPT_COSTOS_ADM(_objEntidad)
    ...
    Sub Imprimir()
        ...
        End If
        'Dim rpta As Long
        Dim ruta As String = Application.StartupPath & "\COSTOSADM_ " & cmbTipo.Text & ".xls"
    ...
    Private Sub poner_cabecera_archivo_excel(ByVal p_archivo As String)
        ...
        Try
            ...
            h_hoja.Range("A:B").ColumnWidth = 5
            h_hoja.Range("C1").ColumnWidth = 9
            h_hoja.Range("D1").ColumnWidth = 56
            h_hoja.Range("E1").ColumnWidth = 6
            h_hoja.Range("F1").ColumnWidth = 9
            h_hoja.Range("G1").ColumnWidth = 7
            h_hoja.Range("F:G").NumberFormat = "#,##0.00"
            ...
            h_hoja.Cells(2, 1).value = "REPORTE COSTOS ADMINISTRATIVOS - " & cmbTipo.Text.ToString.Trim.ToUpper
        Catch ex As Exception
    ...
    Private Sub frmCostosAdm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
