...
#End Region
    ...
    Private Sub FrmListaServicio_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        obj_Proyecto = New NGProyecto
        obj_EProyecto = New ETProyecto
        Dim dtDatos As New DataTable
        dtDatos = obj_Proyecto.Lista_Servicio(obj_EProyecto)
    ...
    Private Sub gridTarea_DoubleClickRow(ByVal sender As Object, ByVal e As Infragistics.Win.UltraWinGrid.DoubleClickRowEventArgs) Handles gridTarea.DoubleClickRow
        Try
            codigo = gridTarea.ActiveRow.Cells("CODIGO").Value
            servicio = gridTarea.ActiveRow.Cells("SERVICIO").Value
            Me.Close()
