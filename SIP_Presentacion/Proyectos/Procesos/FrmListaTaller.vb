...
#End Region
    ...
    Public id_taller As String
    Public taller As String

    Private Sub FrmListaTaller_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        obj_Proyecto = New NGProyecto
        obj_EProyecto = New ETProyecto
        Dim dtDatos As New DataTable
        dtDatos = obj_Proyecto.Lista_Taller(obj_EProyecto)
    ...
    Private Sub gridTarea_DoubleClickRow(ByVal sender As Object, ByVal e As Infragistics.Win.UltraWinGrid.DoubleClickRowEventArgs) Handles gridTarea.DoubleClickRow
        Try
            id_taller = gridTarea.ActiveRow.Cells("ID_TALLER").Value
            taller = gridTarea.ActiveRow.Cells("TALLER").Value
            Me.Close()
