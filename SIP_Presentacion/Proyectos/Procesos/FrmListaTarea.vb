...
#End Region
    ...
    Public id_tarea As Int32
    Public tarea As String
    Private Sub FrmListaTarea_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Private Sub gridTarea_DoubleClickRow(ByVal sender As Object, ByVal e As Infragistics.Win.UltraWinGrid.DoubleClickRowEventArgs) Handles gridTarea.DoubleClickRow
        Try
            id_tarea = gridTarea.ActiveRow.Cells("ID_TAREA").Value
            tarea = gridTarea.ActiveRow.Cells("DESC_TAREA").Value
            Me.Close()
