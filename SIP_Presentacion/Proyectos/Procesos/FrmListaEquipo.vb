...
#End Region
    ...
    Public id_equipo As Int32
    Public equipo As String

    Private Sub FrmListaEquipo_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        obj_Proyecto = New NGProyecto
        obj_EProyecto = New ETProyecto
        Dim dtDatos As New DataTable
        dtDatos = obj_Proyecto.Lista_Equipo(obj_EProyecto)
    ...
    Private Sub gridTarea_DoubleClickRow(ByVal sender As Object, ByVal e As Infragistics.Win.UltraWinGrid.DoubleClickRowEventArgs) Handles gridTarea.DoubleClickRow
        Try
            id_equipo = gridTarea.ActiveRow.Cells("ID_EQUIPO").Value
            equipo = gridTarea.ActiveRow.Cells("EQUIPO").Value
            Me.Close()
