...
Public Class Crp_NoConforme_1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIP_Presentacion.Crp_NoConforme_1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrp_NoConforme_1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Crp_NoConforme_1 = New Crp_NoConforme_1
        rpt.Site = Me.Site
        Return rpt
    End Function
