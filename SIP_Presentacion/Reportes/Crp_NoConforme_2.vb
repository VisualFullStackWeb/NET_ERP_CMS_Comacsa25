...
Public Class Crp_NoConforme_2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIP_Presentacion.Crp_NoConforme_2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrp_NoConforme_2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Crp_NoConforme_2 = New Crp_NoConforme_2
        rpt.Site = Me.Site
        Return rpt
    End Function
