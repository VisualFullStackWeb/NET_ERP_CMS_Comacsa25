...
Public Class Crp_SalidaAlmacen
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIP_Presentacion.Crp_SalidaAlmacen.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrp_SalidaAlmacen
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Crp_SalidaAlmacen = New Crp_SalidaAlmacen
        rpt.Site = Me.Site
        Return rpt
    End Function
