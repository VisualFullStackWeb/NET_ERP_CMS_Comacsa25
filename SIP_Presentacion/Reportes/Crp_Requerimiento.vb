...
Public Class Crp_Requerimiento
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIP_Presentacion.Crp_Requerimiento.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_NROREQ() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCrp_Requerimiento
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Crp_Requerimiento = New Crp_Requerimiento
        rpt.Site = Me.Site
        Return rpt
    End Function
