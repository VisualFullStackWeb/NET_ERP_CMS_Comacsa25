...
Public Class Rpt_SalidaAlmacen
...
#Region "Procedimientos"
    ...
    Sub Iniciar()
        ...
        Dim Listar As New Crp_SalidaAlmacen

        ds1 = ReportesBL.ListarProductosAtendidosDetalle(Trim(gDocumentoSalidaOrden & ""), gDocumentoAtender, Companhia)
