...
Public Class Crp_Cancela_Ant
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIP_Presentacion.Crp_Cancela_Ant.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrp_Cancela_Ant
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Crp_Cancela_Ant = New Crp_Cancela_Ant
        rpt.Site = Me.Site
        Return rpt
    End Function
