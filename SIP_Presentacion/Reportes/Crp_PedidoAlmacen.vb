...
Public Class Crp_PedidoAlmacen
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIP_Presentacion.Crp_PedidoAlmacen.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrp_PedidoAlmacen
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Crp_PedidoAlmacen = New Crp_PedidoAlmacen
        rpt.Site = Me.Site
        Return rpt
    End Function
