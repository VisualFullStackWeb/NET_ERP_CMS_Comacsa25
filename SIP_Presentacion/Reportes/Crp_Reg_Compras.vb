...
Public Class Crp_Reg_Compras
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIP_Presentacion.Crp_Reg_Compras.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrp_Reg_Compras
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Crp_Reg_Compras = New Crp_Reg_Compras
        rpt.Site = Me.Site
        Return rpt
    End Function
