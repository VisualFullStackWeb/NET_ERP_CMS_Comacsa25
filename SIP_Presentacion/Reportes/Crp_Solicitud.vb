...
Public Class Crp_Solicitud
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIP_Presentacion.Crp_Solicitud.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrp_Solicitud
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Crp_Solicitud = New Crp_Solicitud
        rpt.Site = Me.Site
        Return rpt
    End Function
