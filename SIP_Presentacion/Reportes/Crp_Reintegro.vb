...
Public Class Crp_Reintegro
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIP_Presentacion.Crp_Reintegro.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrp_Reintegro
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Crp_Reintegro = New Crp_Reintegro
        rpt.Site = Me.Site
        Return rpt
    End Function
