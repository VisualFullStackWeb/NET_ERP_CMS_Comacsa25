...
Public Class Crp_Reintegro1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIP_Presentacion.Crp_Reintegro1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrp_Reintegro1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Crp_Reintegro1 = New Crp_Reintegro1
        rpt.Site = Me.Site
        Return rpt
    End Function
