...
Public Class Crp_Liquidacion1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIP_Presentacion.Crp_Liquidacion.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrp_Liquidacion1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Crp_Liquidacion1 = New Crp_Liquidacion1
        rpt.Site = Me.Site
        Return rpt
    End Function
