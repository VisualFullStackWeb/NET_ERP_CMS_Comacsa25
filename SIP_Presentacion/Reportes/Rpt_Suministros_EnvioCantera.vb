...
Public Class Rpt_Suministros_EnvioCantera
...
#Region "Procedimientos"
    ...
    Sub Iniciar()
        ...
        Dim Listar As New Crp_Suministros_EnvioCantera

        ds1 = ReportesBL.Suministros_EnvioCantera(Companhia, GFechaInicio, GFechaFin, GOpcion)
