...
Public Class Crp_VidaUtil
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIP_Presentacion.Crp_VidaUtil.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrp_VidaUtil
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Crp_VidaUtil = New Crp_VidaUtil
        rpt.Site = Me.Site
        Return rpt
    End Function
