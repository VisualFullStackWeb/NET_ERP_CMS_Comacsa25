...
Public Class Crp_NoConforme
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIP_Presentacion.Crp_NoConforme.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrp_NoConforme
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Crp_NoConforme = New Crp_NoConforme
        rpt.Site = Me.Site
        Return rpt
    End Function
