...
#End Region
    ...
    Private Sub gridMaquina_InitializeLayout(ByVal sender As System.Object, ByVal e As Infragistics.Win.UltraWinGrid.InitializeLayoutEventArgs) Handles gridMaquina.InitializeLayout
