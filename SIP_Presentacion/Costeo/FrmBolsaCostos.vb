...
#End Region
    ...
    Private Sub FrmBolsaCostos_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Sub Procesar()
        Try
            ...
            dtDatos = _objNegocio.Costo_Bolsa(_objEntidad)
    ...
    Sub Reporte()
        ...
        End If
        Dim rpta As Long
        Dim ruta As String = Application.StartupPath & "\COSTO_BOLSA_" & cmbMes.Text & " " & txtayo.Value & ".xls"
    ...
    Private Sub poner_cabecera_archivo_excel(ByVal p_archivo As String)
        ...
        Try
            ...
            h_hoja.Cells(2, 1).value = "COSTOS EN BOLSA: " & cmbMes.Text & " - " & txtayo.Value
        Catch ex As Exception
