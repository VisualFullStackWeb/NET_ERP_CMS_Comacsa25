...
#End Region
    ...
    Private Sub FrmKardexCosteo_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Sub Procesar()
        Try
            ...
            dtDatos = _objNegocio.Costo_Kardex(_objEntidad)
    ...
    Sub Reporte()
        ...
        End If
        Dim rpta As Long
        Dim ruta As String = Application.StartupPath & "\COSTO_KARDEX_MINERAL_" & cmbMes.Text & " " & txtayo.Value & ".xls"
    ...
    Private Sub poner_cabecera_archivo_excel(ByVal p_archivo As String)
        ...
        Try
            ...
            h_hoja.Range("A3:K3").Merge()
            h_hoja.Range("A3:K3").Font.Bold = True
            h_hoja.Range("A3:AH3").HorizontalAlignment = Microsoft.Office.Interop.Excel.XlVAlign.xlVAlignCenter
            h_hoja.Range("A2:K2").Merge()            
            h_hoja.Range("H:K").ColumnWidth = 13
            h_hoja.Range("D:D").ColumnWidth = 30
            h_hoja.Range("G:G").ColumnWidth = 25
            h_hoja.Range("A:K").NumberFormat = "#,##0.00"
            ...
            h_hoja.Cells(2, 1).value = "KARDEX DE MINERAL: " & cmbMes.Text & " - " & txtayo.Value
        Catch ex As Exception
