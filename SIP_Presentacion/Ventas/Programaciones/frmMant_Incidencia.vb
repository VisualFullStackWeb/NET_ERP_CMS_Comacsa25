...
Public Class frmMant_Incidencia
...
#End Region
    ...
    Private Sub frmMant_Incidencia_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Procesar()
    End Sub
    Sub Procesar()
        Try
    ...
    Private Sub gridConsulta_DoubleClickRow(ByVal sender As Object, ByVal e As Infragistics.Win.UltraWinGrid.DoubleClickRowEventArgs) Handles gridConsulta.DoubleClickRow
        Try
            Tab1.Tabs("T02").Selected = True
            txtid.Text = gridConsulta.ActiveRow.Cells("ID").Value
            txtincidencia.Text = gridConsulta.ActiveRow.Cells("INCIDENCIA").Value
            txtincidencia.Focus()
        Catch ex As Exception
    ...
    Sub Grabar()
        Try
            If MsgBox("Seguro de grabar registro?", MsgBoxStyle.YesNo, msgComacsa) = MsgBoxResult.Yes Then
                ...
                Entidad.Contratista._descripcion = txtincidencia.Text
                Entidad.Contratista.Usuario = User_Sistema
                Dim dtDatos As New DataTable
                dtDatos = New DataTable
                dtDatos = Negocio.NContratista.Mant_Incidencia_Prog(Entidad.Contratista)
