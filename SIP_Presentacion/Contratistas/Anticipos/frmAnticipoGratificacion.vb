...
Public Class frmAnticipoGratificacion
...
#End Region
    ...
    Private Sub frmAnticipoGratificacion_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
        Procesar()
    End Sub

    Private Sub frmAnticipoGratificacion_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Private Sub CargarDatos()
        ...
        Entidad.Contratista._tipoanticipo = "G"
    ...
    Sub SubProceso_Anticipo(ByVal uRow As UltraGridRow)
        ...
        CargarGratificacionAnticipo(NumSolicitud)
    ...
    End Sub
    Sub CargarGratificacionAnticipo(ByVal numsolicitud As String)
        dtPlanilla = New DataTable
        objNegocio = New NGContratista
        objEntidad = New ETContratista
        objEntidad._tipoanticipo = "G"
        objEntidad.NumSolicitud = numsolicitud
        dtPlanilla = objNegocio.ListarGratificacionAniticipo(objEntidad)
        calcularTotal()
    End Sub
    ...
    Sub calcularTotal()
        ...
        If dtPlanilla.Rows.Count > 0 Then
            For i As Int32 = 0 To dtPlanilla.Rows.Count - 1
                subtotalmineral = subtotalmineral + dtPlanilla.Rows(i)("TOTAL")
            Next
    ...
    Sub cargarDatos(ByVal oConn As OleDbConnection, ByVal hoja As String, ByVal formato As Integer)
        ...
        'MsgBox(DtSet.Tables(0).Columns(0).ColumnName)

        'Dim dr() As DataRow
        'dr = table.Select("CTR_DNI = '46368944'")
        ...
        For i As Int32 = 0 To dtPlanilla.Rows.Count - 1
            ...
            objEntidad._gratificacion = dtPlanilla.Rows(i)(_GRATIFICACION)
            ...
            'objEntidad._cts = dtPlanilla.Rows(i)(_CTS)
            objEntidad._usuario = User_Sistema
            objEntidad._tipoanticipo = "G"
    ...
    Private Sub btnver_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnver.Click
        Try
            ...
            Else
                ...
                frm.concepto = "GRATIFICACION"
                frm.Text = "DETALLE DE GRATIFICACION"
                frm.ShowDialog()
            End If
            calcularTotal()
        Catch ex As Exception
    ...
    Public Sub Grabar()
        Try
            ...
            x_descripcion = "POR GRATIFICACION"
            ...
            If Entidad.Contratista.Validacion Then
                ...
                If dtPlanilla.Rows.Count > 0 Then
                    For i As Int32 = 0 To dtPlanilla.Rows.Count - 1
                        ...
                        Entidad.Contratista._gratificacion = dtPlanilla.Rows(i)("TOTAL")
                        Entidad.Contratista._cts = 0
                        Ls_Anticipo.Add(Entidad.Contratista)
                    Next
                    Entidad.Contratista = Negocio.NContratista.InsertaGratiCtsAnticipo(Ls_Anticipo)
                End If
    ...
    Private Sub GridAnticipo_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        Try
            If sender Is Nothing OrElse e Is Nothing Then
                Return
            End If
