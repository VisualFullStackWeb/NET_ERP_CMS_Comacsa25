...
Public Class FrmAnticipo
    ...
    Sub Iniciar()
        Try
            ...
            Dim Listar As New Crp_Anticipo
            ds1 = ReportesBL.RptAnticipo(nroSolicitud)
    ...
    Private Sub FrmAnticipo_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Call Iniciar()
    End Sub
End Class