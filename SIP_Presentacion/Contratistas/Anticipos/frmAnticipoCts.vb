...
#End Region
    ...
    Private Sub frmAnticipoCts_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
        Procesar()
    End Sub

    Private Sub frmAnticipoCts_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Private Sub CargarDatos()
        Try
            ...
            Entidad.Contratista._tipoanticipo = "CTS"
    ...
    Public Sub Grabar()
        Try
            ...
            If cmbMes.Value = 5 Then
                x_descripcion = "POR CTS (NOV-ABR)"
            ElseIf cmbMes.Value = 11 Then
                x_descripcion = "POR CTS (MAY-OCT)"
            End If
            ...
            If Entidad.Contratista.Validacion Then
                ...
                If dtPlanilla.Rows.Count > 0 Then
                    For i As Int32 = 0 To dtPlanilla.Rows.Count - 1
                        ...
                        Entidad.Contratista._cts = dtPlanilla.Rows(i)("TOTAL")
                        Entidad.Contratista._gratificacion = 0
