...
#End Region
    Public Sub CargarDatos()
        Try
            ...
            dtDatos = objNegocio.ListarCliente()
            Call CargarUltraGridxBinding(gridCliente, Source1, dtDatos)
        Catch ex As Exception
            MsgBox(ex.Message)
        End Try
    End Sub

    Private Sub frmBuscarCliente_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        CargarDatos()
    End Sub
