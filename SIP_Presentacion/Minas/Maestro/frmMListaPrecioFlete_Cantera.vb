...
Public Class frmMListaPrecioFlete_Cantera
...
#Region "Eventos"
    ...
    Sub Evento_InitializeLayout(ByVal sender As Object, ByVal e As InitializeLayoutEventArgs) _
        ...
        'For Each uColumn As UltraGridColumn In sender.DisplayLayout.Bands(0).Columns
        '    If Not (uColumn.Key = "Moneda" Or uColumn.Key = "Fecha" Or _
...
#Region "Funciones Locales"
    ...
    Sub Iniciar()
        ...
        Entidad.MyLista = Negocio.CanteraCosteo.ConsultarCanteraListaPrecioFlete(Entidad.CanteraCosteo)
...
#Region "Funciones Globales"
    ...
    Public Sub Buscar()
        ...
        xFormulario = "Lista_Precio_Flete"
    ...
    Public Sub Eliminar()
        ...
        End With
        Call CargarUltraStatusBar(MdiParent, uStatus.Procesando)
        Entidad.Resultado = Negocio.CanteraCosteo.EliminarCanteraListaPrecioFlete(Entidad.CanteraCosteo)
    ...
    Public Sub Grabar()
        ...
        Entidad.Resultado = Negocio.CanteraCosteo.MantenimientoCanteraListaPrecioFlete(Entidad.CanteraCosteo)
        If Entidad.Resultado.Realizo Then
            Call Limpiar()
            Call Iniciar()
            Tab1.Tabs("T01").Selected = Boolean.TrueString
