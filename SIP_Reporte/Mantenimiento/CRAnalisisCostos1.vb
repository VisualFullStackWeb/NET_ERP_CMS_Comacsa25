...
Public Class CRAnalisisCostos1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIP_Reporte.CRAnalisisCostos1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRAnalisisCostos1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRAnalisisCostos1 = New CRAnalisisCostos1
        rpt.Site = Me.Site
        Return rpt
    End Function
