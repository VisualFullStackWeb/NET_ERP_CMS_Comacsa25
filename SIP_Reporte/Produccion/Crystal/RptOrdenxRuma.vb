...
Public Class RptOrdenxRuma
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIP_Reporte.RptOrdenxRuma.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptOrdenxRuma
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptOrdenxRuma = New RptOrdenxRuma
        rpt.Site = Me.Site
        Return rpt
    End Function
