...
Public Class RptProductoxRuma
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIP_Reporte.RptProductoxRuma.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptProductoxRuma
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptProductoxRuma = New RptProductoxRuma
        rpt.Site = Me.Site
        Return rpt
    End Function
