...
Public Class RptProductoxUnidad
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIP_Reporte.RptProductoxUnidad.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptProductoxUnidad
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptProductoxUnidad = New RptProductoxUnidad
        rpt.Site = Me.Site
        Return rpt
    End Function
