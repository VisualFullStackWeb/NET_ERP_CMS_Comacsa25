...
Public Class RptOrdenxSuministro
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RptOrdenxSuministro.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIP_Reporte.RptOrdenxSuministro.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_NroDocumento() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRptOrdenxSuministro
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptOrdenxSuministro = New RptOrdenxSuministro
        rpt.Site = Me.Site
        Return rpt
    End Function
