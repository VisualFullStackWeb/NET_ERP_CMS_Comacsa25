...
Public Class RptRequerimiento
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIP_Reporte.RptRequerimiento.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptRequerimiento
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptRequerimiento = New RptRequerimiento
        rpt.Site = Me.Site
        Return rpt
    End Function
