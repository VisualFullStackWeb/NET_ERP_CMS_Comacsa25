...
Public Class RptProductoxRumaxMineral
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RptProductoxRumaxMineral.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIP_Reporte.RptProductoxRumaxMineral.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptProductoxRumaxMineral
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptProductoxRumaxMineral = New RptProductoxRumaxMineral
        rpt.Site = Me.Site
        Return rpt
    End Function
