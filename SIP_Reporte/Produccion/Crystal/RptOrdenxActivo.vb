...
Public Class RptOrdenxActivo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIP_Reporte.RptOrdenxActivo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptOrdenxActivo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptOrdenxActivo = New RptOrdenxActivo
        rpt.Site = Me.Site
        Return rpt
    End Function
