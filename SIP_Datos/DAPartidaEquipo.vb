...
Public Class DAPartidaEquipo
    Public Function Mantenedor_Part_Equipo(ByVal Ls_Equipo As List(Of ETPartidaEquipo)) As Integer
        Dim lResult As ETPartidaEquipo = Nothing
        ...
        Using conexion As DbConnection = db.CreateConnection
            ...
            Try
                ...
                For Each Ent_Equipo As ETPartidaEquipo In Ls_Equipo
                    Dim cmd As DbCommand = db.GetStoredProcCommand(MPA_Mantenimiento.Mantenimiento_Partida_Equipo)
                    db.AddInParameter(cmd, "PartidaID", DbType.Int32, Ent_Equipo.Partida)
    ...
    Public Function Consultar_Part_Equipo(ByVal Ent_Equipo As ETPartida) As ETMyLista
        ...
        Using dr As IDataReader = db.ExecuteReader(cmd)
            ...
            While dr.Read
                ...
                With Entidad.Partida_Equipo
                    ...
                    .Tipo = 2
                End With
                lResult.Ls_Partida_Equipo.Add(Entidad.Partida_Equipo)
