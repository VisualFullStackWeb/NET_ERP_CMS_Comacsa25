...
Public Class DAPresupuestoMaterial
    Public Function Mantenedor_Presup_Material(ByVal Ls_Material As List(Of ETPresupuestoMaterial)) As Integer
        Dim lResult As ETPresupuestoMaterial = Nothing
        ...
        Using conexion As DbConnection = db.CreateConnection
            ...
            Try
                ...
                For Each Ent_Material As ETPresupuestoMaterial In Ls_Material
                    Dim cmd As DbCommand = db.GetStoredProcCommand(MPA_Mantenimiento.Mantenimiento_Presupuesto_Material)
                    db.AddInParameter(cmd, "DetallePresupuestoID", DbType.Int32, Ent_Material.Presupuesto)
                ...
                lResult = New ETPresupuestoMaterial
                lResult.Respuesta = 1
                Trans.Commit()
                conexion.Close()
        ...
        End Using
    End Function
    Public Function Consultar_Presup_Material(ByVal Ent_Material As ETPresupuestoDetalle) As ETMyLista
        Dim lResult As ETMyLista = Nothing
        If Ent_Material Is Nothing Then Return Nothing

        Dim db As Database = DatabaseFactory.CreateDatabase
        Dim cmd As DbCommand = db.GetStoredProcCommand(MPA_Mantenimiento.Mantenimiento_Presupuesto_Material)
        db.AddInParameter(cmd, "DetallePresupuestoID", DbType.Int32, Ent_Material.PresupuestoDet)
        db.AddInParameter(cmd, "Cod_Cia", DbType.String, Companhia)
        db.AddInParameter(cmd, "Tipo", DbType.String, Ent_Material.Tipo.ToString)
        ...
        Using dr As IDataReader = db.ExecuteReader(cmd)
            ...
            While dr.Read
                ...
                With Entidad.Presupuesto_Material
                    ...
                    .Tipo = 2
                End With
                lResult.Ls_Presupuesto_Material.Add(Entidad.Presupuesto_Material)
            End While
